...
<div class="bg-light bg-opacity-50">
    <h4 style=" padding:20px 0px 0px 20px;">Selamat Datang <b><?php echo $_SESSION['nama']; ?>! | Repost by <a href='https://stokcoding.com/' title='StokCoding.com' target='_blank'>StokCoding.com</a>
    ...
    <div class="row">
        ...
        <div class="col-md">
            <div class="card text-bg-warning mb-3" style="min-width: 18rem;">
                <div class="card-header"><a href="notulen2.php" class="btn btn-light">Lihat</a></div>
                <div class="card-body text-white">
