...
if (isset($_POST['login'])) {
  ...
  if ($result->num_rows == 1 && $_SESSION['role'] == "Admin") {
    ...
    echo "<center><h6 class='alert alert-danger' role='alert'> Username atau Password Anda Salah!</h6></center>";
  }
}
  ...
  <div class="container">
    <div class="row justify-content-center">
      ...
      <div class="col-lg-4 px-4 p-3 bg-white shadow p-3 mb-5 bg-body rounded" style="border-radius: 7px;">
        <?php echo $msg; ?>
        <center><h4 class="fs-4 card-title fw-bold mb-1 p-3">Login</h4></center>
